...
function plaatprotect_system_page() {
	...
	$solar_meter_present_1 = plaatprotect_db_get_config_item('solar_meter_present', SOLAR_METER_1);
	$solar_meter_present_2 = plaatprotect_db_get_config_item('solar_meter_present', SOLAR_METER_2);
	$solar_meter_present_3 = plaatprotect_db_get_config_item('solar_meter_present', SOLAR_METER_3);	
	$energy_meter_present = plaatprotect_db_get_config_item('energy_meter_present', ENERGY_METER_1);
	$gas_meter_present = plaatprotect_db_get_config_item('gas_meter_present', GAS_METER_1);
	$weather_station_present = plaatprotect_db_get_config_item('weather_station_present', WEATHER_METER_1);
	...
	$data1 = plaatprotect_db_fetch_object($result1);
	...
	$data3 = plaatprotect_db_fetch_object($result3);
	...
	$result4 = plaatprotect_db_query($sql4);
	$data4 = plaatprotect_db_fetch_object($result4);
	$power = 0;
	...
	$result5 = plaatprotect_db_query($sql5);
	$data5 = plaatprotect_db_fetch_object($result5);
	...
	$result6 = plaatprotect_db_query($sql6);
	$data6 = plaatprotect_db_fetch_object($result6);
...
function plaatprotect_system() {
  ...
  global $pid;
	...
	switch ($pid) {
		...
		case PAGE_SYSTEM:
			return plaatprotects_system_page();
			break;
	}
}
